<?php
class UserLog3 extends Rqueue
{

	const REDIS_KEY = 'user_log3';

	const REDIS_PROCESS_KEY = 'user_log3_processing';
	const REDIS_SUCCESS_KEY = 'user_log3_success';
	const REDIS_ERROR_KEY = 'user_log3_error';
