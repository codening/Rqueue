<?php
class UserLog2 extends Rqueue
{

	const REDIS_KEY = 'user_log2';

	const REDIS_PROCESS_KEY = 'user_log2_processing';
	const REDIS_SUCCESS_KEY = 'user_log2_success';
	const REDIS_ERROR_KEY = 'user_log2_error';
