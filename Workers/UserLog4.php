<?php
class UserLog4 extends Rqueue
{

	const REDIS_KEY = 'user_log4';

	const REDIS_PROCESS_KEY = 'user_log4_processing';
	const REDIS_SUCCESS_KEY = 'user_log4_success';
	const REDIS_ERROR_KEY = 'user_log4_error';
